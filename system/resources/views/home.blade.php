            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <h3><span class="blu">Rp</span>2.350.000</h3>
                     <p>Sunglass Portal X Pol Black OO9460-1859</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="{{ url('public') }}/images/glass2.png" alt="#"/></figure>
                     <h3><span class="blu">Rp</span>2.640.000</h3>
                     <p>Sunglasses / Sunglass Oakley Feedback P.Chrome</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="{{ url('public') }}/images/glass3.png" alt="#"/></figure>
                     <h3><span class="blu">Rp</span>2.850.000</h3>
                     <p>Essilor Progresif Varilux Liberty 3.0</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="{{ url('public') }}/images/glass4.png" alt="#"/></figure>
                     <h3><span class="blu">Rp</span>3.150.000</h3>
                     <p> Sunglasses Batwolf Matte Black (OO9101-6827) Original</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <h3><span class="blu">Rp</span>2.350.000</h3>
                     <p>Sunglasses ortal X Pol Black OO9460-1859</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     <figure><img src="{{ url('public') }}/images/glass6.png" alt="#"/></figure>
                     <h3><span class="blu">RP</span>2.250.000</h3>
                     <p>Sunglasses Matte Sapphire (OO9464A-0752) Original</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <h3><span class="blu">Rp</span>2.640.000</h3>
                     <p>Sunglasses Feedback P.Chrome (OO4079-4059)</p>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <h3><span class="blu">Rp</span>2.850.000</h3>
                     <p>Sunglasses  Polished Black ( OO9206-3738 ) Original</p>
                  </div>
               </div>
               <div class="col-md-12">
                  <a class="read_more" href="#">Read More</a>
