...
<html lang="en">
   <head>
      ...
      <!-- fevicon -->
      <link rel="icon" href="{{ url('public') }}/fevicon.png" type="image/gif" />
   ...
   <body class="main-layout position_head">
      <!-- loader  -->
      <div class="loader_bg">
         <div class="loader"><img src="{{ url('public') }}/loading.gif" alt="#" /></div>
      </div>
      <!-- end loader -->
      <!-- header -->
      <header>
      ...
      <script>
         ...
         var image = '"{{ url('public') }}/maps-and-flags.png';
